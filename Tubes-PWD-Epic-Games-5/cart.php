...
/* Tambahkan gaya lainnya sesuai kebutuhan */
    ...
    $query = "SELECT * FROM keranjangbelanja AS c, game AS g WHERE c.id_user = '$_SESSION[user_id]' AND c.id_game = g.id_game";
        ...
        <div class="game-item">
            <div class="game-info">
                ...
                <form action='form_buy.php' method='post'>
                    <button class="buy-button"><a href='form_buy.php?id=<?php echo $data['id_game']?>'>Buy Now</a></button>
                </form>
