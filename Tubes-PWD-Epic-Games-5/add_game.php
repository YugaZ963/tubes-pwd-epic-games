    ...
    <div class="container-discover">
        ...
        <form method="post" action="create_game.php">
            <table>
                <tr>
                    <td>Name Game</td>
                    <td><input type="text" name="name_game"></td>
                </tr>
                <tr>
                    <td>Genre Game</td>
                    <td>
                        ...
                        <input type="checkbox" name="genre_game[]" value="action"> Action
                        <input type="checkbox" name="genre_game[]" value="adventure"> Adventure
                        <input type="checkbox" name="genre_game[]" value="RPG"> RPG
                        <input type="checkbox" name="genre_game[]" value="strategy"> Strategy
                        <input type="checkbox" name="genre_game[]" value="simulation"> Simulation
                        <input type="checkbox" name="genre_game[]" value="puzzle"> Puzzle
                        <input type="checkbox" name="genre_game[]" value="sport"> Sport
                        <input type="checkbox" name="genre_game[]" value="FPS"> FPS
                        <input type="checkbox" name="genre_game[]" value="survival"> Survival
                    </td>
                </tr>
